...
class KarutaNet_small(object):
    ...
    def _build_model(self):
        ...
        self._model.add(Conv2D(self.n_filters // 2, self.kernel_size, padding=self.conv_padding, init="he_normal", input_shape=self.input_shape))
        self._model.add(BatchNormalization())
        self._model.add(Activation('relu'))
        self._model.add(MaxPooling2D(pool_size=(2, 2)))

        self._model.add(Conv2D(self.n_filters, self.kernel_size, padding=self.conv_padding, init="he_normal"))
        self._model.add(BatchNormalization())
        self._model.add(Activation('relu'))
